...
# store background
A retail store chain tracks daily sales transactions , including order details , customer info , product categories , order time and order status. The business wants to optimize operations , improve customer experience , and increase profitability using data-driven decisions.
...
<img width="1568" height="848" alt="image" src="https://github.com/user-attachments/assets/f010b043-5eb2-44b8-a1cb-67bf7f3cc0be" />
